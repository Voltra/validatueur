...
export declare const asDate: <T = any>(value?: T | undefined, format?: string | undefined) => Moment.Moment;
export declare const now: <T = any>() => ReturnType<typeof asDate>;
...
export declare const Sanitizers: {
    ...
    moment<T_1>(value: T_1, format?: string | undefined): import("./api/types").ValidationPromise<moment.Moment, undefined>;
    date<T_2>(value: T_2, format?: string | undefined): Promise<Date>;
    ago<T_3>(value: T_3, format?: string | undefined): Promise<string>;
